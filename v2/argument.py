...
def get_args():
    ...
    parser.add_argument('--num_adversary', type=int, default=1, help='number of adversaries')

    #training
    parser.add_argument('--num_epoch', type=int, default=int(2e3), help='number of epoches')
    parser.add_argument('--num_step', type=int, default=50, help='number of steps for a single epoch')
    ...
    parser.add_argument('--noise', type=float, default=.4, help='rate of noise')
    ...
    parser.add_argument('--load', type=bool, default=True, help='whether to load model')
